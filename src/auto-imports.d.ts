...
declare global {
	...
	const getTabPath: (typeof import("./composables/utils"))["getTabPath"];
	...
	const useClient: (typeof import("@unml/client"))["useClient"];
	...
	const useTabs: (typeof import("./composables/state"))["useTabs"];
...
declare module "vue" {
	interface ComponentCustomProperties {
		...
		>;
		readonly getTabPath: UnwrapRef<
			(typeof import("./composables/utils"))["getTabPath"]
		>;
		...
		readonly useClient: UnwrapRef<(typeof import("@unml/client"))["useClient"]>;
		...
		readonly useTabs: UnwrapRef<
			(typeof import("./composables/state"))["useTabs"]
		>;
		...
		>;
		readonly useViews: UnwrapRef<
			(typeof import("./composables/state"))["useViews"]
		>;
